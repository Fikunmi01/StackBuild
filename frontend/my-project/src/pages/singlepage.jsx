        ...
        {post.singlePost.map((item) => (
          <div key={item.postId}>
            ...
            <div className="px-4 w-full items-center flex justify-center flex-col">
              <img src={item.imgSrc} alt="" className="w-[100vh] md:mb-10" />
              <h2 className="font-serif text-3xl md:w-2/4 text-center leading-normal mx-auto font-bold">
                {item.title}
              </h2>
              <span className="flex flex-col-reverse md:flex-row text-lightGray text-xl mb-4 gap-4 items-center justify-center">
                <p>{item.author}</p>
                ...
                <div>
                  ...
                  {!Object.keys(item.comments).length > 0 ? (
                    <div className="font-sans">
                      <p className="italic font-semibold">There's no comment available</p>
